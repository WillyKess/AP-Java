...
// The tests run correctly, with 1600 and 2020 being a leap year and the other three coming back false.
// To run the tests, uncomment all the lines ending in '//test' and comment all those ending in '//normal'.